...
kod_soucastky = input("Prosim zadejte kod soucastky")
pocet_kusu = int(input("Prosim zadejte pocet kusu"))

if kod_soucastky not in sklad:
    print(f'Soucastka {kod_soucastky} neni skladem.')
elif sklad[kod_soucastky] < pocet_kusu:
    print(f'K prodeji je pouze {sklad[kod_soucastky]} kusu.')
...
text = input("Zadej text k prevedeni do Morseovy abecedy")
...
oblast = input("Jaky region te zajima?")

if any(oblast in item.values() for item in staty):
    for item in staty:
        if oblast in item.values():
            print(item["name"])
else:
